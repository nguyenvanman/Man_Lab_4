...
namespace Exercise_7
{
    class Program
    {
        ...
        static void Sort<T>(T[] list)
        {
            for (var i = 0; i < list.Length - 1; i++)
            {
                for (var j = i + 1; j < list.Length; j++)
                {
                    if (((ICompare) list[i]).IsBigger((ICompare) list[j]))
                    {
        ...
        private static void Main(string[] args)
        {
            ...
            var listStudents = new Student[] {student1, student2, student3, student4, student5};
            Sort(listStudents);
            ...
            var listTriangles = new Triangle[] {triangle1, triangle2, triangle3, triangle4, triangle5};
            Sort(listTriangles);
            ...
            var listCountries = new Country[] {country1, country2, country3, country4};
            Sort(listCountries);
